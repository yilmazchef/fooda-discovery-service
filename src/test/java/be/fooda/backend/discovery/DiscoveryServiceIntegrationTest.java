...
import be.fooda.backend.discovery.FoodaDiscoveryApp;

@RunWith(SpringJUnit4ClassRunner.class)
@SpringApplicationConfiguration(classes = FoodaDiscoveryApp.class)
@WebAppConfiguration
@IntegrationTest("server.port=0")
public class DiscoveryServiceIntegrationTest {
